  ...
  const projects = [
    {
      ...
      badge: 'E-Commerce',
      title: 'ShopEasy',
      desc: 'A complete shopping app with secure payments and real-time order tracking.'
    },
    {
      img: '/image copy 7.png',
      badge: 'Healthcare',
      title: 'MediCare+',
      desc: 'Book appointments, consult doctors, and manage health records on the go.'
    },
    {
      img: '/image copy 8.png',
      badge: 'Food Delivery',
      title: 'Foody Express',
      desc: 'Food delivery app with live tracking, easy ordering, and multiple payment options.'
    },
    {
      img: '/image copy 9.png',
      badge: 'Finance',
      title: 'FinTrack',
      desc: 'Personal finance management app to track expenses and manage budgets.'
    }
  ];
