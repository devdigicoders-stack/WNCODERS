...
export default function WebDevelopment() {
  ...
  const offerings = [
    {
      ...
      desc: 'We build custom websites tailored to your business needs and goals.',
      icon: <LuMonitor size={32} />
    },
    {
      title: 'E-Commerce Solutions',
      desc: 'Secure, scalable, and user-friendly e-commerce websites that drive sales.',
      icon: <LuShoppingBag size={32} />
    },
    {
      title: 'Responsive Design',
      desc: 'Fully responsive websites that look and work perfectly on all devices.',
      icon: <LuSmartphone size={32} />
    },
    {
      title: 'Performance Optimization',
      desc: 'We optimize websites for speed, SEO, and overall performance.',
      icon: <LuGauge size={32} />
    },
    {
      title: 'Secure & Scalable Applications',
      desc: 'We build secure and scalable web applications that grow with your business.',
      icon: <LuShieldCheck size={32} />
    },
    {
      title: 'CMS Development',
      desc: "WordPress, Custom CMS, or any platform you prefer - we've got you covered.",
      icon: <LuCode size={32} />
    }
  ];
  ...
  const processSteps = [
    ...
    { num: 2, title: 'Planning & Strategy', desc: 'We plan the architecture, features, and timeline for your project.', icon: <LuClipboardPen size={32} /> },
    { num: 3, title: 'Design & Prototyping', desc: 'We create modern UI/UX designs and interactive prototypes.', icon: <LuCode size={32} /> },
    { num: 4, title: 'Development', desc: 'We build your website using clean, efficient, and scalable code.', icon: <LuAppWindow size={32} /> },
    { num: 5, title: 'Testing & Quality Check', desc: 'We test thoroughly to ensure everything works flawlessly.', icon: <LuTestTube size={32} /> },
    { num: 6, title: 'Deployment & Support', desc: 'We deploy your website and provide ongoing support.', icon: <LuRocket size={32} /> }
  ];

  const technologies = [
    { name: 'HTML5', icon: <SiHtml5 size={45} className="text-[#E34F26]" /> },
    { name: 'CSS3', icon: <SiCss size={45} className="text-[#1572B6]" /> },
    { name: 'JavaScript', icon: <SiJavascript size={45} className="text-[#F7DF1E]" /> },
    { name: 'TypeScript', icon: <SiTypescript size={45} className="text-[#3178C6]" /> },
    { name: 'React', icon: <SiReact size={45} className="text-[#61DAFB]" /> },
    { name: 'Next.js', icon: <SiNextdotjs size={45} className="text-gray-800 dark:text-white" /> },
    { name: 'Vue.js', icon: <SiVuedotjs size={45} className="text-[#4FC08D]" /> },
    { name: 'Angular', icon: <SiAngular size={45} className="text-[#DD0031]" /> },
    { name: 'Node.js', icon: <SiNodedotjs size={45} className="text-[#339933]" /> },
    { name: 'Python', icon: <SiPython size={45} className="text-[#3776AB]" /> },
    { name: 'PHP', icon: <SiPhp size={45} className="text-[#777BB4]" /> },
    ...
    { name: 'Git', icon: <SiGit size={45} className="text-[#F05032]" /> },
    ...
    <div className="w-full bg-[#f8fafc] font-sans overflow-x-hidden">
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-5 leading-tight">
              Web <span className="text-[#00C265]">Development</span>
            </h1>
            
            <p className="text-gray-400 text-base md:text-lg leading-relaxed mb-8 max-w-xl">
              We build fast, responsive, and scalable websites that not only look stunning but also deliver exceptional performance and user experience.
            </p>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
              Custom <span className="text-[#00C265]">Web Solutions</span> for Your Business
            </h2>
          </div>
      ...
      <section className="py-24 px-6 sm:px-10 bg-white border-y border-gray-100">
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
              Our Web <span className="text-[#00C265]">Development</span> Process
            </h2>
          </div>
      ...
      <section className="py-24 bg-white border-t border-gray-100 overflow-hidden">
        <div className="max-w-[1400px] mx-auto text-center px-6 sm:px-10 mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
            Modern <span className="text-[#00C265]">Technologies</span> for Modern Solutions
          </h2>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-8 relative z-10 flex-1">
              ...
              <div>
                ...
                <p className="text-gray-400 text-base md:text-lg max-w-2xl">
                  Let's build something amazing together. We're here to turn your ideas into reality with our expert web development services.
                </p>
              </div>
            </div>
